          ...
          <div className="flex border-b">
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold transition ${
                activeTab === 'teams' ? 'bg-purple-600 text-white' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
              צוותים
            </button>
            ...
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold transition ${
                activeTab === 'notifications' ? 'bg-purple-600 text-white' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
              התראות
            </button>
                    ...
                    <tr key={team._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-sm ${
                          team.averageSentiment > 0.3 ? 'bg-green-100 text-green-800' :
                  ...
                  {notifications.map((notif) => (
                    <div
                      ...
                      className={`p-4 rounded-lg border-r-4 ${
                        notif.type === 'critical' ? 'bg-red-50 border-red-500' :
